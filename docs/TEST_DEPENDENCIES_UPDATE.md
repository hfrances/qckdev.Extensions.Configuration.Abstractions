...
## Proyecto
`qckdev.Extensions.Configuration.Abstractions.Test`
...
```powershell
dotnet test qckdev.Extensions.Configuration.Abstractions.Test\qckdev.Extensions.Configuration.Abstractions.Test.csproj
dotnet test qckdev.Extensions.Configuration.Abstractions.Test\qckdev.Extensions.Configuration.Abstractions.Test.csproj --list-tests
```
